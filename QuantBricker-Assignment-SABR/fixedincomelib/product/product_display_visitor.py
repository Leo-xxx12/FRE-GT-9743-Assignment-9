...
class ProductDisplayVisitor(ProductVisitor):
    ...
    def _(self, product: ProductRFRCapFloor):
        ...
        self.nvps_.append(["Payment BDC", product.payment_business_day_convention.value_str])
        self.nvps_.append(["Payment Holiday", product.payment_holiday_convention.value_str])
